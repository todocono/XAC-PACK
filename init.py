...
if __name__ == '__main__':
    ...
    while crash:
        ...
        if menu == 4:
            font = pygame.font.SysFont(None, 24)
            img = font.render('CHEO XAC-PACK v1.4', True, (0,0,0))
            screen.blit(img, (w/2-100, 20))
            img = font.render('To access panel, connect a keyboard and pres ESC', True, (0,0,0))
            screen.blit(img, (20, 80))
            img = font.render('Test for analog values on Joystick', True, (0,0,0))
            screen.blit(img, (20, h-80))
            button_list = [] #buttonBACK
            mov = pygame.mouse.get_rel()
            #print(mov[0])
            ...
            if abs(x > 0) or abs(y > 0):
                ...
                try:
                    bus.write_i2c_block_data(addr, 0, [0,0,y,x])
                except:
                    pass
                time.sleep(0.001)
