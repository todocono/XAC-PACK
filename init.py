...
if __name__ == '__main__':
    ...
    screen    = pygame.display.set_mode(screen_size) #test for smaller screen size
    ...
    buttonCONFIG = button((w/2+ 150, h/2), (100, 50), (220, 220, 220), (255, 0, 0), func=fnCONFIG, text='Config', font_size = font_size)
